...
- [x] **GNN-03**: Replace MLP Verifier with GNN Verifier in self-play training loop
...
- [x] **ENS-01**: Integrate GNN learned detector as Layer 2 with physics constraints
- [x] **ENS-02**: Implement cascade early exit logic (physics violations skip GNN)
...
| GNN-03 | Phase 2 | Complete |
| SELF-01 | Phase 3 | Deferred (Future Work) |
| SELF-02 | Phase 3 | Deferred (Future Work) |
| ENS-01 | Phase 2 | Complete |
