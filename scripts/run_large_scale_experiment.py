...
def train_selfplay_model(
    ...
    for episode in range(num_episodes):
        ...
        if episode % 10 == 0 and episode > 0:
            ...
            logger.info(
                f"Increased proposer curriculum level to {proposer.curriculum_level:.2f}"
            )
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run large-scale self-play experiment")
    parser.add_argument(
        "--num-households",
        type=int,
        default=50,
